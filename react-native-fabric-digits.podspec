Pod::Spec.new do |s|
    ...
    s.homepage              = "https://github.com/nicholasstephan/react-native-fabric-digits"

    s.author                = { "Jean Lebrument" => "jean@vimies.com" }

    s.platform              = :ios, '7.1'

    s.source                = { :git => "https://github.com/nicholasstephan/react-native-fabric-digits", :tag => s.version.to_s }
